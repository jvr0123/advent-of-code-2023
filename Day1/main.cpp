...
static const std::set<char> sValidTokens {'1', '2', '3', '4', '5', '6', '7', '8', '9'};
static const std::array<std::string, 9> sValidTokenStrings {"one", "two", "three", "four", "five", "six", "seven", "eight", "nine"};
static const std::map<std::string, std::string> sStringLookup{{"one", "1"}, {"two", "2"}, {"three", "3"}, {"four", "4"}, {"five", "5"}, 
